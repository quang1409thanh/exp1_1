...
int UTmain(int argc, char** argv)
{
    ...
    defines.push_back("#define _MSVC_LANG " );
    defines.push_back("#define _MSC_VER " );
    defines.push_back("#define _MSC_FULL_VER ");
    defines.push_back("#define _MSVC_STL_VERSION ");
